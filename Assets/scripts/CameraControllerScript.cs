...
public class CameraControllerScript : MonoBehaviour
{
    ...
    [Header("Perspective atributes")]
    public float minY = 10f;
    public float maxY = 80f;

    [Header("Orthographic atributes")]
    ...
    private void ZoomMoviment(float scroll)
    {
        ...
        else
        {
            ...
            if (scroll == 0)
                return;
            if (fieldOfView - scroll > minSize && fieldOfView - scroll < maxSize)
            {
                fieldOfView = fieldOfView - scroll * 5f * scrollSpeed;
            }
